...
<body>
  <div class='flex font-sans flex-col'>
    ...
    <div class='flex h-full w-full flex-col mb-32 mt-20'>
      ...
      <div class='mx-72'>
        <div class="mb-16 relative h-96">
          <span class="font-semibold text-2xl">Phản hồi ý kiến:</span>

          <textarea name="y_kien" id="y_kien" class="mt-5 w-full h-[17rem] outline-none border-2 border-[#01a14b] rounded-lg p-2 resize-none" placeholder="Nhập phản hồi của bạn tại đây..."></textarea>
          <button type="button" class="absolute right-0 bottom-0 border-2 border-[#01a14b] rounded-md px-4 py-2 mt-4 hover:bg-[#01a14b] hover:text-white">Gửi phản hồi</button>
        </div>
        ...
        <p>
          <span class='font-semibold text-2xl justify-center mr-2'>&#187;</span>
          <span class='italic underline text-lg'>Hotline:</span> 09 9999 9999
        </p>
      </div>
